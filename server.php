...
function callpostagain($data1){
  ...
  $ch = curl_init("http://audiodeadline.com:3007/" . $_GET['q'].'?'.$d);
...
function callgetagain(){
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => "http://audiodeadline.com:3007/" . $_GET['q'],
...
//echo "<pre>";
    //print_r(($response));
    if(strlen($response)>9) echo $response;
    else callgetagain();
